...
import WDI.Evaluation.PublisherEvaluationRuleJaccard;
...
import WDI.fusers.AuthorsFuserIntersectionKSources;
import WDI.fusers.AuthorsFuserMostRecent;
import WDI.fusers.AuthorsFuserUnion;
import WDI.fusers.DateFuserFavourSource;
import WDI.fusers.DateFuserMostRecent;
import WDI.fusers.DateFuserVoting;
import WDI.fusers.GenresFuserUnion;
import WDI.fusers.PagesFuserAverage;
import WDI.fusers.PagesFuserVoting;
import WDI.fusers.PublisherFuserFavourSource;
import WDI.fusers.PublisherFuserShortestString;
import WDI.fusers.RatingCountFuserMedian;
...
public class DataFusion 
{
    ...
    public static void main( String[] args ) throws Exception
    {
		...
		BX_dataset.setDate(LocalDateTime.parse("2004-09-01", formatter));
		books_dataset.setDate(LocalDateTime.parse("2020-02-04", formatter));
		goodread_dataset.setDate(LocalDateTime.parse("2020-07-21", formatter));
		...
		correspondences.loadCorrespondences(new File("data/correspondences/good_books_correspondences.csv"), books_dataset, goodread_dataset);
		...
		strategy.addAttributeFuser(Book.PUBLISHER,new PublisherFuserShortestString(), new PublisherEvaluationRuleJaccard());
		...
		//strategy.addAttributeFuser(Book.RATING_COUNT, new RatingCountFuserMedian(), new RatingCountEvaluationRule());
