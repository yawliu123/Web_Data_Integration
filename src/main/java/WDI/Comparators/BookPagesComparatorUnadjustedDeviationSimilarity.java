 ...
 * 
 */
public class BookPagesComparatorUnadjustedDeviationSimilarity implements Comparator<Book, Attribute> {

	private static final long serialVersionUID = 1L;
	private UnadjustedDeviationSimilarity sim = new UnadjustedDeviationSimilarity();
