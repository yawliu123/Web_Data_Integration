 ...
 * 
 */
public class RatingCountEvaluationRule extends EvaluationRule<Book, Attribute> {
	@Override
	public boolean isEqual(Book record1, Book record2, Attribute schemaElement) {
		int n1 = record1.getRating_count();
		int n2 = record2.getRating_count();

		if(Double.toString(n1)==null && Double.toString(n2)==null)
			return true;
		else if(Double.toString(n1)==null ^ Double.toString(n2)==null)
			return false;
		else
			return n1 == n2;
	}
