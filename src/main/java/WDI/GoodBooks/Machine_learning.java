...
public class Machine_learning {
	...
	public static void main(String[] args) throws Exception {
		...
		"data/goldstandard/goodread_crossing_GS.csv"));
		...
		gsTest.loadFromCSVFile(new File("data/goldstandard/goodread_crossing_GS.csv"));

		// evaluate your result
		System.out.println("*\n*\tEvaluating result\n*");
		MatchingEvaluator<Book, Attribute> evaluator_BX_books = new MatchingEvaluator<Book, Attribute>();
		Performance perfTest_BX_books = evaluator_BX_books.evaluateMatching(correspondences_BX_books, gsTest);
...
//		gsTest_BX_good.loadFromCSVFile(new File("data/goldstandard/.csv"));
//
//		// evaluate your result
//		System.out.println("*\n*\tEvaluating result\n*");
...
//		WekaMatchingRule<Book, Attribute> matchingRule_books_good = new WekaMatchingRule<>(0.7, modelType, options);
...
//		gsTest_books_good.loadFromCSVFile(new File("data/goldstandard/.csv"));
//
//		// evaluate your result
//		System.out.println("*\n*\tEvaluating result\n*");
