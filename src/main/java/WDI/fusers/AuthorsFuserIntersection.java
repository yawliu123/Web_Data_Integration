...
public class AuthorsFuserIntersection extends AttributeValueFuser<List<Author>, Book, Attribute> {

public AuthorsFuserIntersection() {
super(new Intersection<Author, Book, Attribute>());
}
