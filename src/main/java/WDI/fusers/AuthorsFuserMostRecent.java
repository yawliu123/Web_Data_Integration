...
public class AuthorsFuserMostRecent extends AttributeValueFuser<List<Author>, Book, Attribute> {

public AuthorsFuserMostRecent() {
super(new MostRecent<List<Author>, Book, Attribute>());
}
